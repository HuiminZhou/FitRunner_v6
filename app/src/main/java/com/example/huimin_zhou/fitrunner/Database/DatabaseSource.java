package com.example.huimin_zhou.fitrunner.Database;
...
public class DatabaseSource {
    private String[] allColumns = {
            ...
            MySQLOpenHelper.HEART_RATE, MySQLOpenHelper.COMMENT, MySQLOpenHelper.LOCATION};
    ...
    public long insertEntry(ExerciseEntry entry) {
        ...
        values.put(MySQLOpenHelper.COMMENT,         entry.getComment());
    ...
    private ExerciseEntry cursorToEntry(Cursor cursor) {
        ...
        entry.setLocation(Parser.parseByte2Latlng(cursor.getBlob(11)));
        return entry;
    }
}
